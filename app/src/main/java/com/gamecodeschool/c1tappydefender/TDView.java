/**
 * Created by Kripa Shanker on 2/1/16.
 */
...
public class TDView extends SurfaceView implements Runnable {
    ...
    TDView(Context context, int x, int y) {
        ...
        //MediaPlayer mPlayer = MediaPlayer.create(context, R.raw.f);
        //mPlayer.start();
    ...
    private void update() {
        ...
        if(flag==0){
            flag=soundPool.play(start,1,1,0,-1,1);
        }
    ...
    private void draw() {
        ...
        if (ourHolder.getSurface().isValid()) {
            ...
            if(!gameEnded) {
                ...
                canvas.drawText("Time elapsed:" + formatTime(timeTaken) + "s", screenX / 2, 20, paint);
                canvas.drawText("Distance remaining:" + distanceRemaining / 1000 + " KM", screenX / 4, screenY - 20, paint);
                canvas.drawText("Shield left:" + player.getShieldStrength(), 10, screenY - 20, paint);
                canvas.drawText("Speed:" + player.getSpeed() * 60 + " MPS", (screenX / 4) * 3, screenY - 20, paint);
            }else{
                // Show pause screen
                ...
                if(player.getShieldStrength() >0 ) {
                    ...
                    canvas.drawText("You won", screenX / 2, 100, paint);
                    paint.setColor(Color.argb(255, 255, 255, 255));
                }
                else {
